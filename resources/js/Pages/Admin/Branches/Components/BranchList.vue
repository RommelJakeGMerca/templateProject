    ...
    <section class="bg-gray-50 dark:bg-gray-900 h-full p-3 sm:p-5 overflow-y-auto">
        <div
            ...
            <div
                ...
                <button type="button" :disabled="isLoading" @click="refreshBranchesData"
        ...
        <div v-if="branches.length > 0"
            ...
            <div v-for="branch in branches" :key="branch.id"
                ...
                <img src="https://images.unsplash.com/photo-1528297506728-9533d2ac3fa4?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                    alt="branch_default_image"
                ...
                <div class="px-5 pb-5">
                    ...
                    <div class="flex flex-col gap-2">
                        ...
                        <button :disabled="isLoading" type="button" @click="openTransactionsModal(branch.branch_id)"
                        ...
                        <button :disabled="isLoading" type="button" @click="removeBranch(branch)"
